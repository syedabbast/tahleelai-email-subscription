    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 18, marginBottom: 18 }}>
          Dear Coach [USER_NAME],<br />
          Thank you for subscribing to TAHLEEL.ai Coach Platform - the revolutionary AI-powered football tactical analysis system designed specifically for Arab League teams and professional coaches.
          <br />
        ...
        <h3 style={{ color: colors.brightGold, marginBottom: 12 }}>📅 Demo Availability Timeline</h3>
        ...
        <p style={{ marginTop: 12, marginBottom: 6 }}><b>What to Expect Before Demo Launch:</b></p>
        <ul>
        ...
        <h3 style={{ color: colors.brightGold, marginBottom: 12 }}>🎯 Upcoming Features for Coach Demo</h3>
        <ul>
        ...
        <h3 style={{ color: colors.brightGold, marginBottom: 12 }}>💡 Expected Coach Feedback Areas</h3>
        <ul>
        ...
        <h3 style={{ color: colors.brightGold, marginBottom: 12 }}>📧 Communication Schedule</h3>
        <ul>
        ...
        <h3 style={{ color: colors.brightGold, marginBottom: 12 }}>🎮 Demo Session Expectations</h3>
        <ul>
        ...
        <h3 style={{ color: colors.brightGold, marginBottom: 12 }}>🔧 Technical Specifications for Demo</h3>
        <ul>
        ...
        <p style={{ marginTop: 18, fontWeight: 600, textAlign: "center" }}>
